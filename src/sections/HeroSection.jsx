        ...
        <div className="container py-5" style={{ paddingLeft: '100px'}}>
          <div className="row g-5 align-items-left">
            <div className="col-md-12 col-lg-6">
              <h1 className="mb-5 text-8xl text-secondary text-left" style={{fontSize: '96px', marginTop: '-200px'}}>Discover</h1>
              <h1 className="mb-5 text-6xl text-secondary text-left" style={{ fontSize: '64px'}}>Timeless Elegance</h1>
              <h5 className="mb-6 text-left" style={{ fontSize: '16px'}}>
