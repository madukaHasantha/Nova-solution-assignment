...
import backgroundImage from "../assets/img/image2.png"; 
...
export default function HeroSection() {
  ...
  return (
    //Hero Section
    <div
      className="py-5 mt-4 bg-cover container-fluid hero-header md:bg-contain"
      style={{
    ...
    >
      <div className="container py-5 md:px-20">
        <div className="grid items-center grid-cols-1 gap-5 md:grid-cols-2 md:gap-10">
          <div>
            <h1 className="text-4xl text-left md:text-8xl text-secondary md:font-main md:font-regular">
              Discover
            </h1>
            <h1 className="mb-3 text-3xl text-left md:mb-5 md:text-6xl text-secondary md:font-main md:font-regular">
              Timeless Elegance
            </h1>
            <h5 className="mb-4 text-left md:mb-6 md:font-secondary md:font-medium">
              ...
              precious
              <br /> gemstones—the eternal bond of love.
            </h5>
